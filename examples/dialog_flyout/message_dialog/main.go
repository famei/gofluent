// Command message_dialog migrates examples/dialog_flyout/message_dialog/demo.py:
// a mask-backed MessageBox that closes on mask click and supports dragging.
package main
...
func showDialog(parent *qt.QWidget) {
	...
	box := dialog_box.NewMessageBox(title, content, parent)
