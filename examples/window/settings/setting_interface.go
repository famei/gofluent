...
func (s *SettingInterface) buildGroups() {
	...
	s.enableAcrylicCard = settings.NewSwitchSettingCard(
		common.Transparent, "Use Acrylic effect",
	...
	s.themeCard = settings.NewOptionsSettingCard(
		cfg.ThemeMode(), common.Brush, "Application theme", "Change the appearance of your application",
		[]string{"Light", "Dark", "Use system setting"}, s.personalGroup.QWidget)
	s.themeColorCard = settings.NewCustomColorSettingCard(
		cfg.ThemeColor(), common.Palette, "Theme color", "Change the theme color of you application",
	...
	s.languageCard = settings.NewComboBoxSettingCard(
		cfg.Language, common.Language, "Language", "Set your preferred language for UI",
	...
	s.onlineMusicQualityCard = settings.NewOptionsSettingCard(
		cfg.OnlineSongQuality, common.Music, "Online music quality", "",
	...
	s.deskLyricHighlightColorCard = settings.NewColorSettingCard(
		cfg.DeskLyricHighlightColor, common.Palette, "Foreground color", "", s.deskLyricGroup.QWidget, false)
	...
	s.updateOnStartUpCard = settings.NewSwitchSettingCard(
		common.Update, "Check for updates when the application starts",
	...
	s.helpCard = settings.NewHyperlinkCard(
		...
		"Discover new features and learn useful tips about PyQt-Fluent-Widgets", s.aboutGroup.QWidget)
	s.feedbackCard = settings.NewPrimaryPushSettingCard(
		"Provide feedback", common.Feedback, "Provide feedback",
		"Help us improve PyQt-Fluent-Widgets by providing feedback", s.aboutGroup.QWidget)
